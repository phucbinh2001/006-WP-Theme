		...
		$manager->add_section(
			new Type_Pro_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => esc_url_raw('https://www.designlabthemes.com/type-plus-wordpress-theme/?utm_source=WordPress&utm_medium=customizer_button&utm_campaign=type_upsell'),
					'priority' => 1
				)
			)
		);
